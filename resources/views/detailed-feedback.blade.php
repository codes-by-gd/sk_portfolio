...
<section class="py-12 bg-gradient-to-b from-base-100 via-base-100 to-base-200 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div class="w-full">
            ...
            <div class="p-8 sm:p-12 space-y-8">
                ...
                <div class="text-center space-y-2">
                    ...
                    <p class="text-base-content/70 max-w-xl mx-auto text-sm sm:text-base leading-relaxed">
                        {{ __('messages.form.detailed_subtitle') }}
                    </p>
                    <div class="w-16 h-0.5 bg-primary mx-auto mt-4 rounded-full"></div>
                </div>
                ...
                <form action="{{ route('feedback.detailed.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="detailed-feedback-form">
                    ...
                    <div class="space-y-4">
                        <h3 class="font-heading font-bold text-lg text-secondary border-b border-base-300 pb-2"><i class="fa-solid fa-user-tag text-primary mr-1.5"></i> Personal Details</h3>
                        
                        <!-- Floating Label Name using Blade Component -->
                        <x-float-input name="name" :label="__('messages.form.name')" required />

                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <!-- Floating Label Mobile and Area -->
                    ...
                    <div class="space-y-4 pt-4">
                        <h3 class="font-heading font-bold text-lg text-secondary border-b border-base-300 pb-2"><i class="fa-solid fa-square-poll-horizontal text-primary mr-1.5"></i> Feedback & Service Rating</h3>
                        ...
                        <div class="relative w-full">
                            <textarea id="message" name="message" required placeholder=" " rows="4" 
                                class="peer textarea textarea-bordered w-full pt-5 pb-2 min-h-[6rem] bg-base-100 text-base-content border border-base-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary placeholder-transparent transition-all"></textarea>
                            <label for="message" 
                        ...
                        <!-- Rating selection -->
                        <div class="flex flex-col gap-2 bg-base-200 p-4 rounded-xl border border-base-300">
                            <span class="text-xs font-bold text-base-content/75 uppercase tracking-wider">{{ __('messages.form.rating') }}</span>
                    ...
                    <div class="space-y-4 pt-4">
                        <h3 class="font-heading font-bold text-lg text-secondary border-b border-base-300 pb-2"><i class="fa-solid fa-camera text-primary mr-1.5"></i> Camera Capture & Document Upload</h3>
                        
                        <!-- Camera capture interactive workspace -->
                        <div class="card bg-base-200 border border-base-300 p-6 rounded-2xl space-y-4">
                            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                                <div>
                                    <h4 class="font-heading font-bold text-sm text-base-content">Live Camera Capture</h4>
                                    <p class="text-xs text-base-content/60">Capture a live photo of ward issues or development projects using your device camera.</p>
                                </div>
                                <div class="flex gap-2">
                                    <button type="button" id="start-camera-btn" onclick="initCamera()" class="btn btn-xs btn-outline btn-secondary hover:text-white rounded-lg"><i class="fa-solid fa-video"></i> Open Camera</button>
                            ...
                            <div class="relative w-full max-w-md mx-auto aspect-video rounded-xl bg-base-300 border border-base-300 overflow-hidden flex items-center justify-center">
                                ...
                                <div id="camera-placeholder" class="text-center p-4 space-y-2">
                                    <i class="fa-solid fa-camera-rotate text-3xl text-base-content/30"></i>
                                    <p class="text-xs font-semibold text-base-content/50">Camera is closed. Tap "Open Camera" to start.</p>
                                </div>
                            </div>
                        ...
                        <div class="form-control w-full">
                            <label class="label">
                                <span class="label-text font-bold text-xs text-base-content/75 uppercase tracking-wider">Select Files from Device</span>
                            </label>
                            ...
                            <label class="label">
                                <span class="label-text-alt text-base-content/50 text-[10px]">Max image size 5MB. You can select multiple images.</span>
                            </label>
                        </div>
                    </div>
        ...
        <div class="relative flex py-6 items-center">
            ...
            <span class="flex-shrink mx-4 text-base-content/30"><i class="fa-solid fa-comments text-lg"></i></span>
            <div class="flex-grow border-t border-base-300/60"></div>
        </div>
